...
\begin{abstract}
	In our day and age, intellectual property is everywhere. One of the first pages of a book is often the copyright notice, one can not use a software without accepting its EULAs, and after the purchase of a film, one is notified what is considered appropriate use with a often unskippable notice. With a big legal apparatus hunting down offenders, one has to ask the question if the archaic laws of the past are still viable in our present age. In this paper we will provide a broad overview on what intellectual property even means, what notable organisations concern themselves with it, and how the current situation looks like. This analysis is centred on America by design, as it was a big contributor on the globalization, and did not just export its culture but also some of its laws. 
	Through a discourse, we determine that some parts of these laws are still relevant, while others do more harm than good. Our work provides a general overview on what the status quo is, and makes recommendations on how to provide a better alternative in the future.
