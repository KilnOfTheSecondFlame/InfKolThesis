...
\subsection{Pro IP}
In their 2010 study \cite{Artz2010} consolidate findings, that patents are positively related to product announcements, and in turn also to innovation. This does not mean, that patents necessarily drive innovation and invention, but that they are used to protect products derived from the inventions and help companies recuperate spendings invested in the development process. 

It has to be said, that patents itself are relatively unimportant to innovation itself. Outside the pharmaceutical and chemical fields (a finding first observed by \cite{Mansfield1986}), they are usually used strategically to block competitors innovation and delay their ability to imitate the product. 

As in the most fields (apart from the previously mentioned) one can "invent around" a patent relatively cheap, and the cost to prove that a specific patent has been infringed is relatively high. Nonetheless, are patents an important economic instrument to ensure a return on investment of committed resources.
